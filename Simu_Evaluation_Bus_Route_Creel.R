...
# True simulated population for July
...
{  
  ...
  write.table(sum_tab, paste(".\\Results_Bus_route\\July\\summ_tab_", FN, ".txt", sep = ""), sep ="\t", row.names = T)
  write.table(summf, paste(".\\Results_Bus_route\\July\\summ_", FN, ".txt", sep = ""), sep ="\t", row.names = F)
  write.table(simu_res, paste(".\\Results_Bus_route\\July\\", FN, ".txt", sep = ""), col.names = NA, sep ="\t")
}

write.table(res_scenarios, paste(".\\Results_Bus_route\\July\\Results_scenarios_", FN, ".txt", sep = ""), sep ="\t", row.names = F)
